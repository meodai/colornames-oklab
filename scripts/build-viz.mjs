...
<style>
  ...
  * { margin: 0; box-sizing: border-box; }
  ...
  .card .fcss {
    ...
    color: var(--muted); overflow-wrap: anywhere; min-height: calc(3em + .55rem);
  }
...
const makeLabel = (text, p) => {
  ...
  g.font = '400 40px "Libre Caslon Condensed", Georgia, serif';
...
// display-only formatting: 2 decimals keeps the value on two lines, always
const cssLine = (c) =>
  c.tier === 'srgb'
