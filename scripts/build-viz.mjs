...
<style>
  ...
  * { margin: 0; box-sizing: border-box; }
  ...
  .filters button {
    background: #1b1b22; color: #cfcfd8; border: 1px solid var(--line);
    border-radius: 999px; padding: .3rem .85rem; font: inherit; font-size: .8rem;
    cursor: pointer;
  }
  .filters button.active { background: var(--ink); color: #101014; border-color: var(--ink); }
  ...
  .hero-links a {
    font-size: .8rem; text-decoration: none; color: #cfcfd8;
  ...
  #scrolldown {
    ...
    padding: .35rem .9rem; border: 1px solid var(--line); border-radius: 999px; background: #16161ccc;
  ...
  #tip .tier { display: inline-block; font-size: .7rem; padding: .05rem .5rem; border-radius: 999px; margin-top: .35rem; border: 1px solid var(--line); color: #cfcfd8; }
  #toast {
    position: fixed; left: 50%; bottom: 1.2rem; transform: translateX(-50%);
    background: var(--ink); color: #101014; border-radius: 999px; padding: .4rem 1rem;
  ...
  p { color: #c6c6cf; margin-bottom: .85rem; }
  p strong { color: var(--ink); }
  .lede { font-size: 1.12rem; color: var(--ink); }
  code { font: .86em ui-monospace, 'SF Mono', Menlo, monospace; background: #1b1b22; border: 1px solid #26262e; border-radius: 5px; padding: .1em .35em; }
  pre {
    background: var(--panel); border: 1px solid var(--line); border-radius: 10px;
    padding: .9rem 1.1rem; overflow-x: auto; margin: .9rem 0 1.2rem;
  }
  pre code { background: none; border: none; padding: 0; font-size: .84rem; line-height: 1.6; color: #d7d7e0; }
  pre .c { color: var(--faint); }
  table { border-collapse: collapse; width: 100%; margin: .9rem 0 1.2rem; font-size: .9rem; }
  th, td { text-align: left; padding: .45rem .7rem; border-bottom: 1px solid #22222a; vertical-align: top; }
  ...
  footer {
    ...
    border-top: 1px solid #1d1d24; color: var(--faint); font-size: .82rem;
